...
<script type="text/javascript">
	...
	<form name="joinf" action="/join/welcome" method="post" onsubmit="return checkFrm()">
		...
		<br/>
		password: <input type="text" name="passwd"/>   *Password should be at least 8 characters long and should include a mix of letters, numbers, and symbols
		<br/>
		confirm password: <input type="text" name="passwdc"/>
		<br/>
